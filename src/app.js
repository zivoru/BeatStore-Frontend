        ...
        return (
            <div>
                ...
                <Routes>
                    ...
                    <Route path="/purchased" element={userIsPresent ? <Navigate to="/" replace={true}/>
                        : <Purchased user={s.user} setAudio={this.setAudio} openDownload={this.openDownload}
                                     btnPause={this.btnPause} btnPlay={this.btnPlay}
                                     playback={s.playback} playBeatId={s.playerBeat !== null && s.playerBeat !== "empty"
                            ? s.playerBeat.beat.id : null}/>}/>
