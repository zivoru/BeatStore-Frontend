...
class Profile extends Component {
    ...
    myFunction() {
        let copyText = document.getElementById("share-profile");
        copyText.select();
    ...
    render() {
        ...
        if (this.state.userProfile !== null && this.state.userProfile !== "empty") {
            ...
            if (this.state.beats !== null && this.state.beats !== "empty") {
                userBeats =
                    <div style={{marginTop: 40, paddingBottom: 150, position: "relative"}}>
                        ...
                        ? <>
                            ...
                            <div className="sharePopUp pop-up trs"
                                ...
                                <div className="share-link flex-c">
                                    ...
                                    <input id={"share-profile"} value={shareLink + usr.username}
                                           readOnly className="wnohte"/>

                                    <button className="color-bl hu fs14 fw400 ml10" onClick={this.myFunction}
                                            style={{backgroundColor: "transparent"}}
                                    >Копировать
                                    </button>
                                </div>
