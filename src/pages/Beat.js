    ...
    render() {
        ...
        if (this.state.beat !== null && this.state.beat !== "empty") {
            ...
            if (this.state.beat.beat.status !== "SOLD" && this.state.beat.beat.status !== "DRAFT") {
                ...
                if (user !== null && user !== undefined && user !== "empty") {
                    createComment =
                        <div className="comment">
                            ...
                            <div style={{width: 44, height: 44}} className="ml16">
                                <button className="comment-button" onClick={this.createComment}
                ...
                if (beat.key === "CMJ") keyBeat = "До мажор";
                if (beat.key === "FMJ") keyBeat = "Фа мажор";
                if (beat.key === "DMJ") keyBeat = "Ре мажор";
                if (beat.key === "BBMJ") keyBeat = "Си бемоль мажор";
                if (beat.key === "AMJ") keyBeat = "Ля мажор";
                if (beat.key === "EBMJ") keyBeat = "Ми бемоль мажор";
                if (beat.key === "EMJ") keyBeat = "Ми мажор";
                if (beat.key === "ABMJ") keyBeat = "Ля бемоль мажор";
                if (beat.key === "HMJ") keyBeat = "Си мажор";
                if (beat.key === "DBMJ") keyBeat = "Ре бемоль мажор";
                if (beat.key === "FDMJ") keyBeat = "Фа# мажор";
                if (beat.key === "GBMJ") keyBeat = "Соль бемоль мажор";
                if (beat.key === "CDMJ") keyBeat = "До# мажор";
                if (beat.key === "CBMJ") keyBeat = "До бемоль мажор";
                if (beat.key === "GMJ") keyBeat = "Соль мажор";
                if (beat.key === "AM") keyBeat = "ля минор";
                if (beat.key === "GM") keyBeat = "соль минор";
                if (beat.key === "HM") keyBeat = "си минор";
                if (beat.key === "CM") keyBeat = "до минор";
                if (beat.key === "FDM") keyBeat = "фа# минор";
                if (beat.key === "FM") keyBeat = "фа минор";
                if (beat.key === "CDM") keyBeat = "до# минор";
                if (beat.key === "BBM") keyBeat = "си бемоль минор";
                if (beat.key === "GDM") keyBeat = "соль# минор";
                if (beat.key === "EBM") keyBeat = "ми бемоль минор";
                if (beat.key === "DDM") keyBeat = "ре# минор";
                if (beat.key === "ABM") keyBeat = "ля бемоль минор";
                if (beat.key === "ADM") keyBeat = "ля# минор";
                if (beat.key === "EM") keyBeat = "ми минор";
                if (beat.key === "DM") keyBeat = "ре минор";
                                    ...
                                    <div className="content-container">
                                        ...
                                        <div className="content-details">
                                            ...
                                            <div className="color-g1 wnohte fs14 fw400 mt5">
                                                {beat.bpm !== null && beat.bpm !== undefined && beat.bpm !== ""
                                                    ? <>
                                                ...
                                                <span>{keyBeat}</span>
                                                <span style={{padding: "0 5px"}}> • </span>
                                                <span>Прослушивания: {beat.plays}</span>
                                            </div>
                                            ...
                                            return (
                                                <div className="comment" key={index}>
                                                    <div style={{width: 45, height: 45}}>
                                                        <img
                                                            src={profile.imageName !== null && profile.imageName !== "" ?
