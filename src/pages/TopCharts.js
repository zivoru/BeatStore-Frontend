...
const types = [
    {url: "/top-charts", img: 'https://i.ibb.co/6gdRtYf/1.png', title: "Топ чарт", opacity: 1},
...
class TopCharts extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevState.size !== this.state.size) {
            ...
            filters = filters + "priceMin=" + this.state.priceMin + "&priceMax=" + this.state.priceMax + "&bpmMin=" + this.state.bpmMin + "&bpmMax=" + this.state.bpmMax + "&"
    ...
    filterMinBpm = (event) => {
        ...
        filters = filters + "priceMin=" + this.state.priceMin + "&priceMax=" + this.state.priceMax + "&bpmMin=" + event.target.value + "&bpmMax=" + this.state.bpmMax + "&"
    ...
    filterMaxBpm = (event) => {
        ...
        filters = filters + "priceMin=" + this.state.priceMin + "&priceMax=" + this.state.priceMax + "&bpmMin=" + this.state.bpmMin + "&bpmMax=" + event.target.value + "&"
    ...
    filterMinPrice = (event) => {
        ...
        filters = filters + "priceMin=" + event.target.value + "&priceMax=" + this.state.priceMax + "&bpmMin=" + this.state.bpmMin + "&bpmMax=" + this.state.bpmMax + "&"
    ...
    filterMaxPrice = (event) => {
        ...
        filters = filters + "priceMin=" + this.state.priceMin + "&priceMax=" + event.target.value + "&bpmMin=" + this.state.bpmMin + "&bpmMax=" + this.state.bpmMax + "&"
                ...
                <div className="wrapper" style={{paddingBottom: 0}}>
                    ...
                    <div className="container flex-c-sb filters">
                        ...
                        <div className="flex-c filters">
                            ...
                            <div className="filter-cont">
                                <button className="filter flex-c-c"
                                        style={state.priceMin !== 0 || state.priceMax !== 999999 ? {color: "white"} : null}
                                ...
                                {state.filterPrice ?
                                    <div className="pop-up-container" style={{padding: "16px 0", height: "initial"}}>
                                        <div className="pop-up-filter" style={{padding: 0}}>
                                            ...
                                            <input id="bpm-min" type="number" value={this.state.priceMin}
                                            ...
                                            <input id="bpm-max" type="number" value={this.state.priceMax}
